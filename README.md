...
* **CSS3**: Modern styling with custom variables, CSS Grid/Flexbox, smooth animations, and glassmorphism effects.
* **JavaScript (ES6)**: Core application logic and Browser Local Storage management.
* **jQuery**: Simplified DOM manipulation, event handling, and fade animations.
